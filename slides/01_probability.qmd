...
このように $\Omega$ が有限集合の場合、各 $\omega\in\Omega$ について、一つの要素の確率 $P(\{\omega\})$ のみから $P$ が定まる。
...
$\Omega = \{1,2,3,4,5,6\}$ とし、ある $P\colon\Omega\to[0,1]$ について $(\Omega,\,P)$ を確率空間とする。
